...
```{r ozone_summary_plot, echo = FALSE, fig.cap = "Air zone summary plot for 8-hour average ozone"}
params$ozone_summary_plot
```

```{r ozone_caaqs_mgmt_map, fig.cap = "Management level map for ozone."}
params$ozone_caaqs_mgmt_map
```

```{r ozone_caaqs_mgmt_chart, fig.cap = "Management level achievement chart for ozone."}
