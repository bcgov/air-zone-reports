...
output:
  pdf_document:
    ...
    fig_caption: true
    includes:
      in_header: components/header-logo.tex
mainfont: Arial
params:
...
```{r ozone_summary_plot, fig.width = 5, fig.height=8, fig.cap = "Air zone summary plot for 8-hour average ozone"}
...
```{r ozone_caaqs_mgmt_chart, fig.width = 5, fig.asp = 1, fig.cap = "Management level achievement chart for ozone."}
...
```{r pm25_summary_plot, fig.width = 5, fig.height=8, fig.cap = "Air zone summary plot for annual and 24h PM$_{2.5}$"}
...
# TODO: fix label size
# params$pm25_caaqs_mgmt_map$layers[[2]]$aes_params$size <- 4
params$pm25_caaqs_mgmt_map
```

```{r pm25_caaqs_mgmt_chart, fig.width = 5, fig.asp = 1.4, fig.cap = "Management level achievement chart for PM$_{2.5}$."}
