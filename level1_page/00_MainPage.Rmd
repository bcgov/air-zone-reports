...
In this report, O<sub>3</sub> levels are presented using the [8-hour metric](## "Determined by selecting the 4th highest annual value from the highest daily 1-hour values obtained through the 8-hour rolling average measurements, and then calculating this annual value over a span of three consecutive years."). 
