...
Some of the stations are included in the Air Quality Health Index (AQHI) reporting. These stations contain multiple instruments for the simultaneous monitoring and near real-time reporting of PM<sub>2.5</sub>, O<sub>3</sub>, and NO<sub>2</sub>. AQHI is a tool to communicate the health impact of poor air quality.
...
-   The Central Interior and Southern Interior air zones are assigned red management level for fine particulate matter (PM~2.5~) due to high levels PM~2.5~ at Houston, Vanderhoof, and Grand Forks. Under a red management level, the Air Quality Management System recommends taking actions in order to achieve the Canadian Ambient Air Quality Standards. - The highest levels of ozone are observed in the Lower Fraser Valley air zone, resulting in an orange management level. These are due to the levels observed at Hope, Maple Ridge, and Mission. - The Central Interior, Georgia Strait, Lower Fraser Valley, Northeast, and Southern Interior are under orange management level for nitrogen dioxide (NO~2~). - The Southern Interior air zone is assigned red management level for sulphur dioxide (SO~2~) due to the high SO~2~ levels at Trail. All other air zones are under green management level.
...
knitr::include_app('https://bcgov-env.shinyapps.io/pm_exceedance/',height = "600px")
```
