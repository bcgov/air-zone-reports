...
```
# There are Four Pollutants Featured in This Air Zone Report

## Fine Particulate Matter, Ozone, Nitrogen Dioxide, and Sulphur Dioxide

These are considered pollutants of major concern due to their effects on health and the environment. As a result of these concerns, these pollutants were priority for standards setting. The Canadian Ambient Air Quality Standards (CAAQS) was developed for fine particulate matter and ozone in 2012, and these were following by nitrogen dioxide and sulphur dioxide in 2015.

According to the Environment Management Act, an air contaminant or pollutant means a substance introduced into the air that can affect the health or safety of a person, visibility, and may cause damage or injury to property, life form, and the environment.
...
<div class="panel">
  <p>
  Particulate matter (PM) consists of airborne particles in solid or liquid form. PM may be classified as primary or secondary, depending on the process that led to its formation. Primary PM is emitted directly into the atmosphere from a source, such as a smokestack or exhaust pipe, or from wind-blown soils or vehicle traffic on a dirt road. Secondary PM is formed in the atmosphere through a series of chemical and physical reactions involving gases such as sulphur oxides (SOx) and nitrogen oxides (NOx). PM exists in various sizes and the particles of most concern for human health are those with a diameter of less than 2.5 micrometres (PM<sub>2.5</sub>).
  There are two metrics for PM<sub>2.5</sub>. 
