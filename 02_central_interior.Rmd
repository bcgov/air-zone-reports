...
```{r airzone-map, fig.width = 6, fig.cap = paste(airzone, "Air Zone")}
airzone_map(airzone)
```
...
```{r ozone-by-station, fig.width = 6, fig.height=4, fig.cap = ozone_by_station_cap(airzone, ozone)}
...
```{r pm25-by-station, fig.width = 6, fig.height=8.5, fig.cap = pm25_by_station_cap(airzone, pm25)}
