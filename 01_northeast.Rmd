...
`r min(ozone$metric_value_ambient, na.rm = TRUE)` to `r max(ozone$metric_value_ambient, na.rm = TRUE)` ppb. These levels `r tolower(as.character(o3_az$caaqs_ambient))` the national standard of `r achievement_level("o3")` ppb.
