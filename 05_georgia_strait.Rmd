...
```{r airzone-map, fig.align = "center", out.width = "90%", fig.cap = "Map of air zone"}
knitr::include_graphics("placeholdermap.png")
```
...
```{r annual-ozone, fig.width = 6, fig.cap = annual_ozone_cap(annual_ozone)}
...
```{r annual-pm25, fig.width = 6, fig.cap = annual_pm25_cap(annual_pm25)}
...
## \newpage Air Zone Management Levels
